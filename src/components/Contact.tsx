        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            ...
            <div className="flex flex-col gap-6">
              <a href="mailto:kathilshiva@gmail.com" className="contact-item group flex items-center justify-between p-6 sm:p-8 rounded-3xl border border-white/10 hover:bg-white hover:text-black transition-all duration-500">
              ...
              <a href="https://www.linkedin.com/in/ayushkathil" target="_blank" rel="noreferrer" className="contact-item group flex items-center justify-between p-6 sm:p-8 rounded-3xl border border-white/10 hover:bg-white hover:text-black transition-all duration-500">
              ...
              <a href="https://github.com/Ayush-kathil" target="_blank" rel="noreferrer" className="contact-item group flex items-center justify-between p-6 sm:p-8 rounded-3xl border border-white/10 hover:bg-white hover:text-black transition-all duration-500">
                <div className="flex items-center gap-4 sm:gap-6">
          ...
          <div className="flex flex-col justify-end lg:items-end">
            <div className="contact-item w-full max-w-md p-8 sm:p-12 rounded-[var(--radius-uber)] bg-white/5 border border-white/10 backdrop-blur-3xl">
